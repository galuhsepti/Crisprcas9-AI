"""Preflight or execute the locked Phase 18H positional-region ablation."""
...
from src.feature_ablation.phase18h import (  # noqa: E402
    run_campaign,
    run_preflight,
)
...
def main(argv=None):
    ...
    with phase18c_access_guard():
        ...
        print(f"Phase 18H results: {results_dir.relative_to(ROOT).as_posix()}")
        print(f"Phase 18H models: {models_dir.relative_to(ROOT).as_posix()}")
